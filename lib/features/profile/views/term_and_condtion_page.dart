...
class TermsConditionPage extends ConsumerWidget {
  const TermsConditionPage({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final asyncValue = ref.watch(termsConditionProvider);
            ...
            child: Column(
              ...
              children: [
                _HeaderCard(
                  ...
                  subtitle: 'Please read the rules and guidelines carefully.',
                ),
