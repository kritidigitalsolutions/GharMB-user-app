...
class AppColors {
  static const Color primary = Color(0xFFF35402);
  static const Color card = Color(0xFFF9F8FD);
  ...
  // Status Colors
  static const Color success = Color(0xFF2EAC5A);
  static const Color error = Color(0xFFF82824);
